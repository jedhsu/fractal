//! Cognition is the training process.
//!
//! The AlphaZero training process consists in `num_iters` iterations.
//!
//! Each iteration of `Recognize` can be decomposed into:
//!   [1] `Reflect` - a self-play phase.
//!   [2] `Evolve` - a learning phase.
//!

pub struct Cognition {
    //! Top-level struct containing all parameters.
